...
export default function Home() {
  ...
  >([
    [
      {
        id: "xxijiji",
        text: 'Example comment on the text: "For one, an opportunity to meet", this section is well writen but if ever more content needs to be added, "For one" can be omitted.',
        author: "AI",
